...
export default function Appealing({ parentForm }) {
	...
	const userServer = localStorage.getItem('server') ?? 1;
	...
	const errors = [{ id: 1, value: "Другое" }];
	...
	return (
		<div>
			<div className="mb-5">
				<DisclosureItem head={"Правила подачи обжалования наказания"}>
			...
			<BlueButton
				onClick={() => postForm()}
				className={"ml-auto !max-w-[300px] mt-6 !py-4"}>
				Создать
			</BlueButton>
		</div>
	);
